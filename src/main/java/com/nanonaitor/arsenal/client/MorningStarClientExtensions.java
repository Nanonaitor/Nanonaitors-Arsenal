...
public final class MorningStarClientExtensions implements IClientItemExtensions {
    private static final HumanoidModel.ArmPose RAISED = HumanoidModel.ArmPose.create(
        "NANONAITORS_MORNING_STAR_RAISED", false, true, MorningStarClientExtensions::poseRaised);
    private static final HumanoidModel.ArmPose HORIZONTAL = HumanoidModel.ArmPose.create(
        "NANONAITORS_MORNING_STAR_HORIZONTAL", false, true, MorningStarClientExtensions::poseHorizontal);
    ...
    private static void poseRaised(HumanoidModel<? extends HumanoidRenderState> model,
    ...
    private static void poseHorizontal(HumanoidModel<? extends HumanoidRenderState> model,
            HumanoidRenderState state, HumanoidArm arm) {
        var active = arm == HumanoidArm.RIGHT ? model.rightArm : model.leftArm;
        var passive = arm == HumanoidArm.RIGHT ? model.leftArm : model.rightArm;
        active.xRot = -1.30F;
